...
import { idSchema, validateParams, heroSchema, validateBody } from '../helpers/validation'
...
export class HeroRouter {
   ...
   * Create one 
   */
  async createOne(req: Request | any, res: Response, next: NextFunction) {
    try {
   ...
   * GET one hero by id
   */
  async getOne(req: Request | any, res: Response, next: NextFunction) {
    try {
